...
namespace NavigationBar
{
    ...
    {
        private string activeTab = "Educations";
        ...
        public EducationForm()
        {
            ...
            this.Text = "Portfolio - Educations";
        ...
        {
            if (tabName == "Educations") return;
            this.Close();
            switch (tabName)
            {
                case "Home": new ManotaHome().Show(); break;
        ...
        {
            // Form load event - initialization handled in constructor
        }
